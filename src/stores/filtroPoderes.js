...
const PREDEFINED_TAGS = [
    ...
    { name: "Poder de Raça", value: "poder_raca" },
    { name: "Poder de Grupo", value: "poder_grupo" },
    ...
    { name: "Duende", value: "duende" },
    { name: "Eiradaan", value: "eiradaan" },
    { name: "Galokk", value: "galokk" },
    { name: "Meio-Elfo", value: "meio_elfo" },
    { name: "Sátiro", value: "satiro" },
    { name: "Treinador", value: "treinador" },
    { name: "Alquimista", value: "alquimista"  },
    { name: "Atleta", value: "atleta" },
    { name: "Burguês", value: "burgues" },
    { name: "Duelista", value: "duelista" },
    { name: "Ermitão", value: "ermitao" },
    { name: "Inovador", value: "inovador" },
    { name: "Machado de Pedra", value: "machado_pedra" },
    { name: "Magimarcialista", value: "magimarcialista" },
    { name: "Necromante", value: "necromante" },
    { name: "Santo", value: "santo" },
    { name: "Seteiro", value: "seteiro" },
    { name: "Usurpador", value: "usurpador" },
    { name: "Vassalo", value: "vassalo" },
    { name: "Ventanista", value: "ventanista" },
    ...
    { name: "O Deus das Cidades", value: "deus_cidades" },
    { name: "O Deus do Medo", value: "deus_medo" },
